...
My model achieve accuracy: 0.3738 in the validation and 
...
Tha model can be integrated by deploying the trained model TensowFlow Lite for mobile where user can upload images or take pictures using their cameras or using TensorFlow.js to run directly in browser. 
